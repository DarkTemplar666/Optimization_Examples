function [xf, fobj, info, VF, VFmean, optTime] = Hip_Implant_with_torsion_IsoPar(varargin)
%-------------------------------------------------------------------------%
...
%% FEM
% Geometry
model = mphload('Hip_Implant_with_torsion.mph');
[~,meshdata] = mphmeshstats(model,'mesh2'); % Mesh with 14977 elements
% [~,meshdata] = mphmeshstats(model,'mesh3'); % Mesh with 849153 elements
...
% Output file
printlevel = 5;
file = ['Hip_Implant_with_torsion_NEle',num2str(nele)];
